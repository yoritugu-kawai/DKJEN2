#include "RenderTextrurePSO.h"


RenderTextrurePSO* RenderTextrurePSO::GetInstance()
{
	static RenderTextrurePSO instance;

	return &instance;
}
void RenderTextrurePSO::CreatePSO()
{
	ShapePSO();
}

void RenderTextrurePSO::Release()
{
	if (RenderTextrurePSO::GetInstance()->pso_.Texture.errorBlob)
	{
		RenderTextrurePSO::GetInstance()->pso_.Texture.errorBlob->Release();
	}
	RenderTextrurePSO::GetInstance()->pso_.Texture.GraphicsPipelineState->Release();
	RenderTextrurePSO::GetInstance()->pso_.Texture.rootSignature->Release();
	RenderTextrurePSO::GetInstance()->pso_.Texture.signatureBlob->Release();
}

void RenderTextrurePSO::ShapePSO()
{
	...
	ShaderMode shader = RenderTextrureCompileShader::GetInstance()->GetShaders().shape;
	...
	RenderTextrurePSO::GetInstance()->pso_.Texture = ShapePSO;
